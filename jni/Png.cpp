	...
	u_char **outData)
{
  ...
  png_set_read_fn(png_ptr, buf, Png::callbackRead);
  offset_ = 8;
...
void Png::callbackRead(png_structp pPng, png_bytep buf, png_size_t size)
{
